...
#CUSTOM SETTINGS
LOGIN_REDIRECT_URL = '/qualApp/'

#EMAIL_BACKEND = 'django.core.mail.backends.dummy.EmailBackend'
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
#EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'\
execfile(PATH_TO_PROJECT+"eMail.py")
#my private e-mail information file (eMail.py) looks like this:
...
ADMINS = (
     ('Michael Folkerts', 'mfolkerts@physics.ucsd.edu'),
)
...
MEDIA_ROOT = PATH_TO_PROJECT+'db.files/'
...
TEMPLATE_CONTEXT_PROCESSORS = (
	...
	'django.contrib.auth.context_processors.auth', # got a warning without this?
...
SECRET_KEY = '6)hb_o(xbpc#s@fs#@z#(3^$6%r=+nsp(c4n_v=%7uie(z3h!y'
